...
<button id="edit_button" onClick="editWord();" type="button">Convert Word to Image</button>
<button id="incr_button" onClick="increaseSize();" type="button">Thicker</button>
<button id="decr_button" onClick="decreaseSize();" type="button">Thinner</button>
</div>
<div>
<button id="copy_button" onClick="copyWord();" type="button">Copy Selected Object</button>
<button id="del_button" onClick="deleteWord();" type="button">Delete Selected Object</button>
<button id="top_button" onClick="topWord();" type="button">Move Selected Object To Top</button>
</div>
<div>
